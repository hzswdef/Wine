...
import TagPageContent from "@components/pages/Tag/children/TagPageContent";
import TagPageFooter from "@components/pages/Tag/children/TagPageFooter";
...
const Tag = () => {
	...
	return (
		<PageBase page="tag" title={`"${tag}" Tag`} className="capitalize">
			...
			<TagPageContent posts={posts.posts} />
			<TagPageFooter
